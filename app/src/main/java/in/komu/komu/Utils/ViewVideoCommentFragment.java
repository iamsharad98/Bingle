...
public class ViewVideoCommentFragment extends Fragment {

    private static final String TAG = "ViewVideoCommentFragment";


    public ViewVideoCommentFragment(){
        super();
    ...
    private void addNewComment(String newComment){
        ...
        myRef.child(getString(R.string.db_all_videos))
...
//                .setValue(comment);
    ...
    private String getCallingActivityFromBundle(){
        ...
        if(bundle != null) {
                return bundle.getParcelable(mContext.getString(R.string.newsfeed_video));
        }else{
            return null;
        }
    }
    ...
    private Video getVideoFromBundle(){
        ...
        Bundle bundle = this.getArguments();
        if(bundle != null) {
                    return bundle.getParcelable(mContext.getString(R.string.videos));
        }else{
            return null;
        }
    }

//    if (bundle.equals(mContext.getString(R.string.videos))){
//                return bundle.getParcelable(mContext.getString(R.string.videos));
//            }else {
    ...
    private void setupFirebaseAuth(){
        ...
        if(mVideo.getComments().size() == 0){
            ...
            firstComment.setDate_created(mVideo.getTimestamp());
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                                    ...
                                    video.setDuration(objectMap.get(mContext.getString(R.string.field_video_duration)).toString());
                                    video.setCategory(objectMap.get(mContext.getString(R.string.field_category)).toString());
                                    video.setViews(objectMap.get(mContext.getString(R.string.field_video_views)).toString());
